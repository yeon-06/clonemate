...
public class CustomUserService implements UserDetailsService {
    private static final String ERROR_NO_USER = "[ERROR] 해당 사용자가 없습니다. -> %s";
    private static final String ERROR_NO_ACCOUNT = "[ERROR] 계정 정보를 불러올 수 없습니다.";
    ...
    public CustomUserDetails loadUserByUsername(String account) throws UsernameNotFoundException {
        ...
        User user = userRepository.findByAccount(account)
                .orElseThrow(() -> new IllegalArgumentException(String.format(ERROR_NO_USER, account)));
